...
from datetime import timedelta  # Correctly importing timedelta

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-&n7d+_ffg^dw@8zqj5osf5264_2tdvoe)qy4q*!kb6xgu@q!io'
...
INSTALLED_APPS = [
    ...
    # Add your apps here
    'accounts',  # Your accounts app for user authentication
